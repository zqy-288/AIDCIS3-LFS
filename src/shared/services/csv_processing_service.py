...
class CSVProcessingService(QObject):
    """
    统一CSV数据处理服务
    ...
    def __init__(self, parent=None):
        ...
        # 数据格式配置 - 支持中英文列名
        self.column_mapping = {
            'depth': ['depth', 'z', 'position', '深度', '位置', 'prof', 'profondeur'],
            'diameter': ['diameter', 'width', 'measurement', '直径', '测量值', 'diam', 'diametre'],
            'timestamp': ['timestamp', 'time', 'datetime', '时间', '时间戳', 'temps']
        }
