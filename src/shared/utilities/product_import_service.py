...
from src.pages.main_detection_p1.modules.dxf.dxf_product_converter import DXFProductConverter
from src.shared.models.product_model import ProductModel, get_product_manager
