...
from ...shared.view_models.main_view_model import MainViewModel
from ...shared.view_models.view_model_manager import MainViewModelManager
from ...core.exceptions.main_exceptions import CoordinatorError
    ...
    def _on_business_state_changed(self, state_type: str, new_state: Any) -> None:
        ...
        try:
            ...
            if state_type == 'detection':
                from ...shared.view_models.enums import DetectionState
                ...
                from ...shared.view_models.enums import SimulationState
