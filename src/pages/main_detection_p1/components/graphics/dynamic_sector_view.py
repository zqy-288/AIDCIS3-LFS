...
class DynamicSectorDisplayWidget(QWidget):
    ...
    def _create_panorama_widget(self):
        """创建浮动全景图 - 使用重构后的架构"""
        from src.pages.main_detection_p1.components.graphics.panorama_view.core.di_container import PanoramaDIContainer
        from src.pages.main_detection_p1.components.graphics.panorama_view.adapters.legacy_adapter import CompletePanoramaWidgetAdapter
