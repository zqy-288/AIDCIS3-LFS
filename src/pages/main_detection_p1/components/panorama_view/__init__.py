...
# 注意：CompletePanoramaWidget已被工件图全景预览组件替代，适配器已移除
...
__all__ = [
    ...
    # === 注意：向后兼容组件已移除 ===
    # 'CompletePanoramaWidget',      # 已替换为工件图全景预览组件
    # 'CompletePanoramaWidgetAdapter', # 适配器已移除
    # 'create_legacy_panorama_widget', # 工厂函数已移除
