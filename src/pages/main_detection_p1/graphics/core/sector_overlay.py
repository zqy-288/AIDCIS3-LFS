...
from src.pages.main_detection_p1.graphics.core.sector_manager import SectorQuadrant
from src.pages.main_detection_p1.graphics.core.enhanced_sector_manager import EnhancedSectorManager
from src.pages.main_detection_p1.graphics.core.sector_compatibility import create_compatible_sector_manager, CompatibilityMode
