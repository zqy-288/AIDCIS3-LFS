...
class EnhancedReportGenerator(ReportGenerator):
    ...
    def __init__(self, db_manager=None):
        ...
        self.chart_temp_dir = Path("temp_charts")
    ...
    def generate_comprehensive_pdf_report(self, hole_data: Dict, 
        ...
        # 调用父类方法生成PDF，但使用增强的数据
        return super().generate_static_pdf_report(hole_data, workpiece_info)
