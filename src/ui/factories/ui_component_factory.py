...
# 延迟导入，只在需要时加载
_component_modules = {
    'realtime_chart': 'src.modules.realtime_chart',
    'worker_thread': 'src.modules.worker_thread',
    'history_viewer': 'src.modules.unified_history_viewer',
    'report_interface': 'src.modules.report_output_interface',
...
_component_classes = {
    ...
    'history_viewer': 'UnifiedHistoryViewer',
