...
from .di_container import PanoramaDIContainer, get_global_container, reset_global_container

# 事件系统
from .event_bus import PanoramaEventBus, PanoramaEvent, EventData
...
# 向后兼容适配器
from .legacy_adapter import CompletePanoramaWidgetAdapter, CompletePanoramaWidget, create_legacy_panorama_widget
